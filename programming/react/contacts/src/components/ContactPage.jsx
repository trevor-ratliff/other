    ...
    return (
      <div id="contact-page">
        ...
        <div id="colTest" className="bob" style={{"border": "1px solid #333333", "backgroundColor": "#aaaaaa"}}>
          ...
          <div>
            <div className="col-2" style={{"backgroundColor": 'hsla(45, 100%, 100%, 1)'}}>&nbsp;</div>
            <div className="col-2" style={{"backgroundColor": 'hsla(45, 90%, 90%, 1)'}}>&nbsp;</div>
          </div>
          <div>
            <div className="col-3" style={{"backgroundColor": 'hsla(90, 100%, 100%, 1)'}}>&nbsp;</div>
          ...
          <div>
            <div className="col-4" style={{"backgroundColor": 'hsla(135, 100%, 100%, 1)'}}>&nbsp;</div>
          ...
          <div>
            <div className="col-5" style={{"backgroundColor": 'hsla(180, 100%, 100%, 1)'}}>&nbsp;</div>
          ...
          <div>
            <div className="col-7" style={{"backgroundColor": 'hsla(270, 100%, 100%, 1)'}}>&nbsp;</div>
          ...
          <div>
            <div className="col-8" style={{"backgroundColor": 'hsla(315, 100%, 100%, 1)'}}>&nbsp;</div>
